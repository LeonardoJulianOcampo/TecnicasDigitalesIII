...
/* Private defines -----------------------------------------------------------*/
#define A_IN8_Pin GPIO_PIN_0
#define A_IN8_GPIO_Port GPIOA
#define IN_MUX_Pin GPIO_PIN_1
#define IN_MUX_GPIO_Port GPIOA
#define D_IN7_Pin GPIO_PIN_2
#define D_IN7_GPIO_Port GPIOA
#define D_IN6_Pin GPIO_PIN_3
#define D_IN6_GPIO_Port GPIOA
#define D_IN5_Pin GPIO_PIN_4
#define D_IN5_GPIO_Port GPIOA
#define D_IN4_Pin GPIO_PIN_5
...
#define D_OUT3_Pin GPIO_PIN_10
#define D_OUT3_GPIO_Port GPIOA
#define D_OUT7_Pin GPIO_PIN_15
#define D_OUT7_GPIO_Port GPIOA
#define D_OUT8_Pin GPIO_PIN_3
...
#define A_OUT2_Pin GPIO_PIN_6
#define A_OUT2_GPIO_Port GPIOB
#define A_OUT1_Pin GPIO_PIN_7
#define A_OUT1_GPIO_Port GPIOB
